...
from {{cookiecutter.project_name}}.settings import ACTIVATE_LOGS, LOG_AUTHENTICATED_USERS_ONLY, IP_ADDRESS_HEADERS
...
patterns =[{"values":["version","resources","extra_resource"],"pattern":url1},
...
class UserLoggerMiddleware(object):
    ...
    def __call__(self, request):
        ...
        if request.path[:5] not in API_URLS:return response
        # self.writelog(1, request, response)
