...
from client.views import RetrieveUpdateClient, CreateListUser, ForgotPasswordView, \
    ChangePasswordAPiView, ResetPasswordView, ResendVerifyEmailView, RetrieveUpdateUser, ResetEnumeratorPassword
...
urlpatterns=[
    ...
    url(r'^admin-reset-password/?$', ResetEnumeratorPassword.as_view(), name="admin_reset_enum_password"),
]